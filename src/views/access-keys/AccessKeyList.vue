<template>
  <div class="app-page access-keys">
    <el-card shadow="hover" class="access-card">
      <template #header>
        <div class="page-header">
          <div>
            <p class="eyebrow">安全凭证</p>
            <h2>Access Key 管理</h2>
...
.access-keys :deep(.el-card__header) {
  border-bottom: 1px solid #eef2f7;
  background: transparent;
}

.access-keys :deep(.el-table) {
  border-radius: 12px;
  overflow: hidden;
}

.access-keys :deep(.el-table__header-wrapper th) {
  background: #f8fafc;
}
</style>
